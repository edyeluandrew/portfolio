  ...
  const projects = [
    {
      ...
      image: "https://via.placeholder.com/400x300/1e293b/d4af37?text=Beta+Tech+Labs", // Replace with actual image URL
      technologies: ["React", "Tailwind CSS", "JavaScript", "Framer Motion"],
      githubLink: "https://github.com/edyeluandrew/beta-tech-labs", // Update with actual repo if different
      liveLink: "https://research-eta-eosin.vercel.app/", // Update with actual live link if different
      stats: [
    ...
    },
    {
      ...
      category: "Web Development",
      image: "https://via.placeholder.com/400x300/1e293b/d4af37?text=Novak+Hospitality", // Replace with actual image URL
      technologies: ["HTML5", "CSS3", "JavaScript", "Bootstrap"],
      githubLink: "https://github.com/edyeluandrew/novak-hospitality", // Update with actual repo if different
      liveLink: "http://novak-site.vercel.app", // Update with actual live link if different
      stats: [
